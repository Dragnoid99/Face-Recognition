...
database = {}
database["akhilesh"] = img_to_encoding("images/akhilesh.png", FRmodel)



#Just to verify whether everything is done right (triplet loss, weights, database)
...
# Checking it
who_is_it("/Downloads/akhilesh.jpg",database,FRModel)     # Correctly outputs Akhilesh
